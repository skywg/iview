...
public class SessionStatusFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		LoginUser systemLoginUser = (LoginUser) req.getSession().getAttribute("currentUser");
		if (!matcher
				&& (req.getSession(false) == null || systemLoginUser == null)) {
		...
		/*if (systemLoginUser != null) {
			MDC.put("USER_ID", systemLoginUser.getLoginAccount());
			MDC.put("USER_NAME", systemLoginUser.getDisplayName());
